...
要注意题目非常明显的给出了提示，函数是单调的，也就是提示可以使用二分查找来进行搜索，这两有点像[leetcode 240 搜索二维矩阵 ||](https://leetcode-cn.com/problems/search-a-2d-matrix-ii/)这道题，这里是查找答案数，先搜索出一个边界，接着从边界向搜索即可。代码如下。
